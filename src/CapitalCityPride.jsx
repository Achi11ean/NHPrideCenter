...
import { FaInstagram, FaFacebook, FaEnvelope, FaCalendarAlt, FaMapMarkerAlt } from "react-icons/fa";
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        // Find an event with "Hartford City Pride" in the notes
      ...
      .catch((err) => console.error("Error loading pride event:", err));
  }, []);
...
<div
  className="mt-6 inline-block bg-gradient-to-r from-pink-500 via-purple-600 to-indigo-700 px-6 py-3 rounded-none font-bold shadow-xl border-2 border-white cursor-pointer hover:scale-105 transition"
  onClick={() => {
    if (prideEvent?.slug) {
      if (
        window.confirm(
  ...
  {prideEvent ? (
    ...
    "🌈 June 2025 • Downtown Hartford"
      ...
      <section className="max-w-4xl mx-auto text-center px-6 py-10">
        <h2 className="text-3xl font-bold text-pink-300 mb-4">The Biggest Pride Event in Hartford</h2>

        <p className="text-slate-200 leading-relaxed text-lg">
          Every June, thousands come together in Hartford to celebrate love, identity, diversity, 
          and resilience. The Hartford City Pride Festival features live entertainment, vendors, 
          community resources, a massive parade, and a celebration that lights up the city.
        </p>
      </section>
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-6 py-10">
        ...
        <div className="bg-black/60 p-6 rounded-2xl border border-pink-400/40 shadow-lg">
          ...
          <h3 className="text-xl font-bold text-pink-300 mb-2">Festival Highlights</h3>
        ...
        <div className="bg-black/60 p-6 rounded-2xl border border-purple-400/40 shadow-lg">
          ...
          <h3 className="text-xl font-bold text-purple-300 mb-2">Pride Parade</h3>
          <ul className="text-slate-200 text-sm space-y-2">
        ...
        <div className="bg-black/60 p-6 rounded-2xl border border-indigo-400/40 shadow-lg">
          ...
          <h3 className="text-xl font-bold text-indigo-300 mb-2">Special Events</h3>
          <ul className="text-slate-200 text-sm space-y-2">
      ...
      {/* 🛍️ VENDOR INFO */}
{/* 🛍️ VENDOR / SPONSOR / VOLUNTEER SECTIONS */}
<section className="max-w-5xl mx-auto px-6 py-10 space-y-16">
  ...
  <div className="text-center bg-black/40 rounded-xl p-6 border-2 border-yellow-400/40 shadow-xl">
    <h2 className="text-3xl font-bold text-yellow-300 mb-3">Become a Vendor</h2>

    <p className="text-slate-200 text-lg mb-6">
      Sell products, food, art, or showcase your organization at one of the 
      most highly attended Pride events in Connecticut.  
      Vendor applications include booth placement, visibility options,  
      and add-ons for power, tenting, and branding.
    </p>
  ...
  <div className="text-center bg-black/40 rounded-xl p-6 border-2 border-pink-400/40 shadow-xl">
    <h2 className="text-3xl font-bold text-pink-300 mb-3">Become a Sponsor</h2>

    <p className="text-slate-200 text-lg mb-6">
      Support Hartford City Pride while gaining powerful brand visibility.  
      Sponsorship levels include logo placements, stage mentions,  
      parade features, VIP access, and custom partnership opportunities.
    </p>
  ...
  <div className="text-center bg-black/40 rounded-xl p-6 border-2 border-teal-400/40 shadow-xl">
    <h2 className="text-3xl font-bold text-teal-300 mb-3">Become a Volunteer</h2>

    <p className="text-slate-200 text-lg mb-6">
      Help us create a safe, joyful, and inclusive Pride experience!  
      Volunteers assist with event setup, parade flow, info booths,  
      accessibility services, youth programming, and more.
    </p>
...
{showSponsorModal && (
  <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
    <div className="relative bg-white text-black max-w-3xl w-full max-h-[85vh] overflow-y-auto rounded-xl shadow-2xl border-4 border-pink-500">
      ...
      {/* Actual Sponsor Page Content Rendered Inside */}
      <div className="">
      ...
      <section className="max-w-4xl mx-auto px-6 pb-16">
        <h2 className="text-3xl font-bold text-center text-cyan-300 mb-4">Festival Location</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 divide-y lg:divide-y-0 lg:divide-x lg:divide-gray-700">
          ...
          <div className="text-center lg:text-left lg:pl-6">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 text-2xl">
              <a href="https://www.instagram.com/hartfordpride/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
              <a href="https://www.facebook.com/HartfordPrideCenter" target="_blank" rel="noopener noreferrer"><FaFacebook /></a>
              <a href="mailto:info@hartfordpridecenter.org"><FaEnvelope /></a>
            </div>
          </div>
        </div>
